    ...
    <div class="max-w-2xl m-auto">
      ...
      <div class="text-lg text-gray-900 leading-normal space-y-6">
        <p class="my-4" role="">
          ...
          <strong class="text-blue-700 font-bold">Laravel</strong> and
          <strong class="text-blue-700 font-bold">Vue</strong>.
        </p>
        <p class="my-4">
          You can know all about me and my work about software development
          through my
          <nuxt-link
            class="text-blue-700 font-bold underline"
            to="/jobs"
