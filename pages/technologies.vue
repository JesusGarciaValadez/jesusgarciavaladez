  ...
  >
    <div class="max-w-full">
      <div class="font-sans text-lg text-gray-900 leading-normal space-y-6">
        ...
        <p class="my-4">
          Also, I work a lot in my soft skills as to how to make a hiring
          process, how to give feedback, how to help coworkers without beign
          invasive, how to manage my time, etc.
        </p>
        <p class="my-4">
          I can add that if I don’t know some technology, I can learn it really
          fast.
        </p>
      </div>
    </div>
