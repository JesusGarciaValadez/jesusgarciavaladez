    ...
    <div class="max-w-full">
      ...
      <div class="text-lg text-gray-900 leading-normal space-y-6">
        <p class="my-4">
          ...
          <strong class="text-blue-700 font-bold">JavaScript</strong> (<strong
        ...
        <p class="my-4">
          After that, I was
          <strong class="text-blue-700 font-bold">CTO</strong> at another
          ...
          agency (how to make
          <strong class="text-blue-700 font-bold">DevOps</strong> for each
          ...
          <strong class="text-blue-700 font-bold">CSS preprocessor</strong>, to
        ...
        <p class="my-4">
          ...
          <strong class="text-blue-700 font-bold">Laravel</strong> for 5 of
          their developments (one of them at my charge) with a little team of 5
          devs. I can say that was my first touch with
          <strong class="text-blue-700 font-bold"> Laravel</strong> but every
          development was a success. (I tend to learn quite fast). I started
          with <strong class="text-blue-700 font-bold">Laravel 5.0</strong> and
          the use of <strong class="text-blue-700 font-bold">Docker</strong> and
        ...
        <p class="my-4">
          ...
          <strong class="text-blue-700 font-bold">Laravel</strong> with
          <strong class="text-blue-700 font-bold">web components</strong>
