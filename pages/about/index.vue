...
import GitHubIcon from '~/components/SocialIconsGithubIcon.vue'
import InstagramIcon from '~/components/SocialIconsInstagramIcon.vue'
import LinkedInIcon from '~/components/SocialIconsLinkedInIcon.vue'
import XIcon from '~/components/SocialIconsXIcon.vue'
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'I’m Jesús García. I live in Breda City, where I design the future.',
    },
  ],
})
</script>
