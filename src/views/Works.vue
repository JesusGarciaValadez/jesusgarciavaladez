<template>
  ...
  >
    <div class="max-w-full">
      <h1 class="text-2xl font-extrabold text-gray-900 mb-4" role="heading">Works</h1>
      <div class="text-lg text-gray-900 leading-normal space-y-6">
        ...
        <ul class="list-disc pl-5 w-full text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg" role="list">
          <WorkOnlineList v-for="(work, index) in worksOnline" :key="index" :work="work"></WorkOnlineList>
        </ul>
        <h2 class="my-4" role="heading">Some clients for whose projects I worked:</h2>
        <ul class="list-disc pl-5 w-full text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg" role="list">
          <WorkOfflineList v-for="(work, index) in worksOffline" :key="index" :work="work"></WorkOfflineList>
        </ul>
      </div>
    </div>
  </main>
...
<script lang="js">
import WorkOnlineList from '@/components/WorkOnlineList';
import WorkOfflineList from '@/components/WorkOfflineList';
