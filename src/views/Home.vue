<template>
  ...
  lg:px-32 lg:pb-20 lg:pt-10 lg:pb-20 mt-10 md:mt-0 lg:mt-0 xl:mt-0">
    <div class="max-w-2xl m-auto">
      <h1 class="text-2xl font-extrabold text-gray-900 mb-4" role="heading">
        Who am I and what I do?</h1>
      <div class="text-lg text-gray-900 leading-normal space-y-6">
        ...
        <p class="my-4">
          ...
          <router-link class="text-blue-700 font-bold underline" to="/jobs" role="link"
                       aria-label="Jobs">jobs, </router-link>
          <router-link class="text-blue-700 font-bold underline" to="/works" role="link"
                       aria-label="Works">works, </router-link>
          <router-link class="text-blue-700 font-bold underline" to="/tech" role="link"
        ...
        <p class="my-4">
          ...
          <router-link class="text-blue-700 font-bold underline" to="uses" role="link"
                       aria-label="Uses">uses</router-link> page for a full list of all the
          software, gadgets, and services I use.
        </p>
      </div>
    </div>
  </main>
